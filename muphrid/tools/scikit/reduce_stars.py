...
within star regions. Unlike star_restoration with star_weight < 1.0
...
Apply to the final combined image after star_restoration, or directly before export.
Not a substitute for good registration; intended for residual star size
reduction after all other processing is complete.

Algorithm:
1. Build binary star mask from star_removal output or auto-threshold luminance
...
def reduce_stars(
    ...
    # use (post-star_restoration, pre-export) is display, but state authority means
