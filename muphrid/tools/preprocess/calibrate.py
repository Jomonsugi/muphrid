...
Agent reasoning guide — set flags based on camera_model from ingest_dataset:
...
def calibrate(
    ...
    Args:
        ...
        optimize_dark: Dark scaling: 'auto' (compute coefficient from frame
            statistics), 'exp' (scale by lights/dark exposure ratio read from
            the frames automatically), or null (no scaling — set when
