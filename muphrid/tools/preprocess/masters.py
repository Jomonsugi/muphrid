...
Sensor-relative diagnostic thresholds:
    ...
    black_level and white_level (passed via acquisition_meta from ingest_dataset). This
...
def _resolve_sensor_levels(
    ...
    Priority:
      1. acquisition_meta (from ingest_dataset — already paid for, most reliable)
      2. EXIF from first input file (fallback if ingest_dataset wasn't run / not passed)
