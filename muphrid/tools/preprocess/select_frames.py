...
based on analyze_frames summary statistics and the specific dataset.
...
class SelectionCriteria(BaseModel):
    ...
    min_star_count: int | None = Field(
        ...
        description=(
            ...
            "Derive from analyze_frames summary.median_star_count — set to ~50% of "
    ...
    min_quality: float | None = Field(
        ...
        description=(
            ...
            "of analyze_frames summary.median_quality for moderate filtering."
        ),
    )
...
def select_frames(
    ...
    for siril_stack to consume.

    Args:
        criteria: Rejection thresholds. Tune based on analyze_frames summary statistics:
          ...
          - min_star_count: set to ~50% of median_star_count from analyze_frames summary
    ...
    if not frame_metrics:
        raise ValueError(
            "frame_stats is empty in state. Run analyze_frames first."
        )
