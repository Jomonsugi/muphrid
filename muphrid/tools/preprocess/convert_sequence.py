...
prerequisite for calibrate. Light files come from state["dataset"]["files"]["lights"].

Used by:
  - build_masters internally for calibration frames via _convert_to_sequence
  - The agent for light frames before calibrate
...
def convert_sequence(
    ...
    in the dataset working directory. Must be called before calibrate.
