...
file. This tool returns the calibrated_sequence name so analyze_frames can parse it.
...
def siril_register(
    ...
    if not calibrated_sequence:
        raise ValueError("calibrated_sequence not found in state. Run calibrate first.")
    ...
    # pattern established by calibrate (see its _count_calibrated_files).
