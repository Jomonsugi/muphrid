...
if TYPE_CHECKING:
    from muphrid.config import Settings
...
def init_memory_system(settings: Settings, rebuild_embeddings: bool = False) -> None:
    ...
    """
    from muphrid.graph.hitl import set_memory_enabled
    from muphrid.graph.registry import register_memory_tool
    from muphrid.memory.store import MemoryStore
    from muphrid.tools.utility.t33_memory_search import set_memory_store
