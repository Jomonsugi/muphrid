...
The store is a single SQLite file at ~/.muphrid/memory.db. It holds
...
DEFAULT_DB_PATH = Path.home() / ".muphrid" / "memory.db"
...
class MemoryStore:
    ...
    def check_embedding_model(
        ...
        the vector index.
        """
        from muphrid.memory.embeddings import EmbeddingInitError
